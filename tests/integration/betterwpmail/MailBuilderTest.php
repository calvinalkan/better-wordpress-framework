...
namespace Tests\integration\betterwpmail;
...
use Tests\integration\betterwpmail\fixtures\Emails\HtmlMail;
use Tests\integration\betterwpmail\fixtures\Emails\WelcomeEmail;
use Tests\integration\betterwpmail\fixtures\Emails\PlainTextMail;
use Tests\integration\betterwpmail\fixtures\Emails\MultiPartEmail;
use Tests\integration\betterwpmail\fixtures\Emails\CustomSenderMail;
use Tests\integration\betterwpmail\fixtures\Emails\ImageAttachmentMail;
use Tests\integration\betterwpmail\fixtures\Emails\InMemoryAttachmentMail;
use Tests\integration\betterwpmail\fixtures\Emails\CombinedAttachmentMail;
use Tests\integration\betterwpmail\fixtures\Emails\EmbeddedByPathAttachmentMail;
use Tests\integration\betterwpmail\fixtures\Emails\InlineAttachmentCIDTemplateMail;
use Tests\integration\betterwpmail\fixtures\Emails\EmbeddedFromMemoryAttachmentMail;
...
final class MailBuilderTest extends WPTestCase
{
    ...
    public function testExceptionWhenSubject()
    {
        ...
        $this->expectExceptionMessage(
            'The mailable [Tests\integration\betterwpmail\fixtures\Emails\IncorrectMail] has no subject line.'
        );
