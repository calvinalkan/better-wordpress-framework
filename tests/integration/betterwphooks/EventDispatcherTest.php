...
namespace Tests\integration\betterwphooks;
...
use Tests\integration\betterwphooks\fixtures\FooEvent;
use Tests\integration\betterwphooks\fixtures\BarEvent;
use Tests\integration\betterwphooks\fixtures\ClassListener;
use Tests\integration\betterwphooks\fixtures\ClassListener2;
use Tests\integration\betterwphooks\fixtures\WildcardListener;
...
class EventDispatcherTest extends WPTestCase
{
    ...
    public function test_missing_handle_method_exception()
    {
        ...
        $this->expectExceptionMessage(
            "The listener [Tests\integration\betterwphooks\\fixtures\ListenerWithNoHandleMethod] does not have a handle method and is not invokable with __invoke().",
        );
    ...
    public function test_invalid_array_listener_method_exception()
    {
        ...
        $this->expectException(InvalidListenerException::class);
        $this->expectExceptionMessage(
            "The listener [Tests\integration\betterwphooks\\fixtures\ClassListener] does not have a handle method and is not invokable with __invoke()."
        );
