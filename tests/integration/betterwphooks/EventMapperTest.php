...
class EventMapperTest extends WPTestCase
{
    ...
    public function test_exception_if_filtering_during_the_same_same_filter()
    {
        ...
        $this->expectExceptionMessage(
            "You can can't map the event [Tests\integration\betterwphooks\EmptyActionEvent] to the hook [wp_hook] after it was fired."
        );
    ...
    {
        $this->expectExceptionMessage(
            "Tried to map the event class [Tests\integration\betterwphooks\EventFilter1] twice to the [foobar] filter."
        );
