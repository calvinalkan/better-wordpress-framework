...
class ImmutableEventTest extends WPTestCase
{
    ...
    public function private_properties_cant_be_read()
    {
        ...
        try {
            ...
            $this->assertStringStartsWith(
                "The property [bar] is private on the class [Tests\integration\betterwphooks\ProxiedEvent].",
                $e->getMessage()
            );
        }
    }
    ...
    public function public_properties_cant_be_written()
    {
        ...
        try {
            ...
            $this->assertStringStartsWith(
                'The event [Tests\integration\betterwphooks\ProxiedEvent] is an action and cant be changed.',
                $e->getMessage()
            );
        }
    }
    ...
    public function other_methods_can_not_be_called()
    {
        ...
        try {
            ...
            $this->assertStringStartsWith(
                "The method [bogus] is not callable on the action event [Tests\integration\betterwphooks\ProxiedEvent].",
                $e->getMessage()
            );
        }
    }
