...
use Tests\integration\database\fixtures\Models\City;
...
use Tests\integration\database\fixtures\Models\Activity;
use Tests\integration\database\fixtures\Factories\CountryFactory;
...
class DatabaseFactoriesTest extends WPTestCase
{
    ...
    protected function setUp() :void
    {
        ...
        $eloquent->withDatabaseFactories(
            'Tests\\integration\\database\\fixtures\\Models\\',
            'Tests\\integration\\database\\fixtures\\Factories\\',
        );
